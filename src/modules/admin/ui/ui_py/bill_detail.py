...
# Form implementation generated from reading ui file 'ui_design/bill_detail.ui'
#
...
"")
        ...
        self.verticalLayout_9.setContentsMargins(20, 14, 20, 20)
...
"}")
        ...
        self.lineEdit_5.setMinimumSize(QtCore.QSize(300, 35))
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Chi tiết phiếu xuất"))
        self.label_2.setText(_translate("Form", "ID phiếu xuất : "))
        self.lineEdit.setText(_translate("Form", "900001"))
        self.label_3.setText(_translate("Form", "ID nhân viên xuất hàng :"))
        self.lineEdit_2.setText(_translate("Form", "900001"))
        self.label_4.setText(_translate("Form", "Tên nhân viên xuất hàng : "))
        self.lineEdit_3.setText(_translate("Form", "Nguyễn Văn A"))
        self.label_5.setText(_translate("Form", "ID khách hàng : "))
        self.lineEdit_4.setText(_translate("Form", "110001"))
        self.label_6.setText(_translate("Form", "Rank : "))
        self.lineEdit_5.setText(_translate("Form", "Bạc"))
