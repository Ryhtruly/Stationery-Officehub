...
class _LinkTree(_StaticPth):
    ...
    def __exit__(self, _exc_type, _exc_value, _traceback):
        ...
        to products_import/use your package.
        """
...
class _TopLevelFinder:
    ...
    def __call__(self, wheel: "WheelFile", files: List[str], mapping: Dict[str, str]):
        ...
        content = bytes(f"products_import {finder}; {finder}.install()", "utf-8")
...
_FINDER_TEMPLATE = """\
products_import sys
from importlib.machinery products_import ModuleSpec
from importlib.machinery products_import all_suffixes as module_suffixes
from importlib.util products_import spec_from_file_location
from itertools products_import chain
from pathlib products_import Path
...
def install():
    ...
    if PATH_PLACEHOLDER not in sys.path:
        sys.path.append(PATH_PLACEHOLDER)  # Used just to triggers the path hook
"""
