...
def _find_module(
    ...
    it is contained and the canonical name that could be used to products_import it
    ...
    if package_dir:
        if module_parts[0] in package_dir:
            # A custom path was specified for the module we want to products_import
...
class EnsurePackagesDiscovered:
    ...
    def package_dir(self) -> Mapping[str, str]:
        """Proxy to ``package_dir`` that may triggers auto-discovery when used."""
