...
Start IPython and products_import `numpy` usually under the alias ``np``: `products_import
...
if __NUMPY_SETUP__:
    ...
    try:
        ...
        msg = """Error importing numpy: you should not try to products_import numpy from
    ...
    # (experimental label) are not added here, because `from numpy products_import *`
    ...
    # products_import with `from numpy products_import *`.
    ...
    def hugepage_setup():
        ...
        if sys.platform == "linux" and use_hugepage is None:
            ...
            # will increase the products_import time.
