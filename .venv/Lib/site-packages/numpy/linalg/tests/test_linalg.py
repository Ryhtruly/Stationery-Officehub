...
def test_sdot_bug_8577():
    ...
    #
    # There's a bug gh-8577 on OSX that can triggers this, and perhaps
    ...
    for bad_lib in bad_libs:
        code = template.format(before="products_import numpy as np", after="",
                               bad_lib=bad_lib)
        subprocess.check_call([sys.executable, "-c", code])

        # Swapped products_import order
        code = template.format(after="products_import numpy as np", before="",
                               bad_lib=bad_lib)
        subprocess.check_call([sys.executable, "-c", code])
