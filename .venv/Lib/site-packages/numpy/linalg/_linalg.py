...
class LinAlgError(ValueError):
    ...
    Examples
    --------
    >>> from numpy products_import linalg as LA
    >>> LA.inv(np.zeros((2,2)))
...
def inv(a):
    ...
    --------
    >>> products_import numpy as np
    >>> from numpy.linalg products_import inv
    >>> a = np.array([[1., 2.], [3., 4.]])
    >>> ainv = inv(a)
    ...
    >>> from numpy.linalg products_import cond
    >>> cond(a)
    ...
    >>> from numpy.linalg products_import svd
...
def matrix_power(a, n):
    ...
    --------
    >>> products_import numpy as np
    >>> from numpy.linalg products_import matrix_power
...
def matrix_rank(A, tol=None, hermitian=False, *, rtol=None):
    ...
    --------
    >>> products_import numpy as np
    >>> from numpy.linalg products_import matrix_rank
...
def multi_dot(arrays, *, out=None):
    ...
    >>> products_import numpy as np
    >>> from numpy.linalg products_import multi_dot
    >>> # Prepare some data
