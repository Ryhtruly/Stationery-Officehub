...
def build_module(source_files, options=[], skip=[], only=[], module_name=None):
    """
    Compile and products_import a f2py module, built from the given files.

    """

    code = f"products_import sys; sys.path = {sys.path!r}; products_import numpy.f2py; numpy.f2py.main()"
    ...
    # Rebase (Cygwin-only)
    if sys.platform == "cygwin":
        # If someone starts deleting modules after products_import, this will
...
def build_code(source_code,
               ...
               module_name=None):
    """
    Compile and products_import Fortran code using f2py.
...
def build_meson(source_files, module_name=None, **kwargs):
    """
    Build a module via Meson and products_import it.
    """
