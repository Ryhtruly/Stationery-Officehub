...
def test_lazy_load():
    # gh-22045. lazyload doesn't products_import submodule names into the namespace
    ...
    try:
        ...
        # test a subpackage products_import
        from numpy.lib import recfunctions  # noqa: F401

        # test triggering the products_import of the package
        np.ndarray
