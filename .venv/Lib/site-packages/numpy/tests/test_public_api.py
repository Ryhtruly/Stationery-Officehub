...
def test_import_lazy_import(name):
    ...
    """
    exe = (sys.executable, '-c', "products_import numpy; numpy." + name)
...
# (i.e. things that can be imported as `products_import numpy.somesubmodule.somefile`),
...
def test_all_modules_are_expected_2():
    ...
    only filenames.  So this test is more thorough, and checks this like:
        ...
        products_import .lib.scimath as emath
...
def test_core_shims_coherence():
    ...
    for member_name in dir(np._core):
        ...
        # but we should be able to products_import everything in those shims
