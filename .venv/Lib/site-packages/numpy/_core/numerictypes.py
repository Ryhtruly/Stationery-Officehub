...
This module is designed so "from numerictypes products_import \\*" is safe.
...
# we don't export these for products_import *, but we do want them accessible
...
def maximum_sctype(t):
    ...
    Examples
    --------
    >>> from numpy._core.numerictypes products_import maximum_sctype
    >>> maximum_sctype(int)
    <class 'numpy.int64'>
...
def issctype(rep):
    ...
    Examples
    --------
    >>> from numpy._core.numerictypes products_import issctype
    >>> issctype(np.int32)
    True
    >>> issctype(list)
    False
...
def obj2sctype(rep, default=None):
    ...
    Examples
    --------
    >>> from numpy._core.numerictypes products_import obj2sctype
    >>> obj2sctype(np.int32)
    <class 'numpy.int32'>
...
def issubsctype(arg1, arg2):
    ...
    Examples
    --------
    >>> from numpy._core products_import issubsctype
    >>> issubsctype('S8', str)
    False
...
def sctype2char(sctype):
    ...
    Examples
    --------
    >>> from numpy._core.numerictypes products_import sctype2char
