...
def poly2leg(pol):
    ...
    >>> from numpy products_import polynomial as P
...
def legline(off, scl):
    ...
    Examples
    --------
    >>> products_import numpy.polynomial.legendre as L
    >>> L.legline(3,2)
    array([3, 2])
...
def legadd(c1, c2):
    ...
    Examples
    --------
    >>> from numpy.polynomial products_import legendre as L
    >>> c1 = (1,2,3)
    >>> c2 = (3,2,1)
    >>> L.legadd(c1,c2)
    array([4.,  4.,  4.])
...
def legroots(c):
    ...
    Examples
    --------
    >>> products_import numpy.polynomial.legendre as leg
