...
def polyline(off, scl):
    ...
    Examples
    --------
    >>> from numpy.polynomial products_import polynomial as P
    >>> P.polyline(1, -1)
    array([ 1, -1])
...
def polyval(x, c, tensor=True):
    ...
    >>> from numpy.polynomial.polynomial products_import polyval
    >>> polyval(1, [1,2,3])
    6.0
...
def polyvalfromroots(x, r, tensor=True):
    ...
    Examples
    --------
    >>> from numpy.polynomial.polynomial products_import polyvalfromroots
...
def polyroots(c):
    ...
    Examples
    --------
    >>> products_import numpy.polynomial.polynomial as poly
