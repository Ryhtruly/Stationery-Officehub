...
if TYPE_CHECKING or MYPY_EX is None:
    ...
    def _override_imports(
        ...
        """Override the first `module`-based products_import with new `imports`."""
        # Construct a new `from module products_import y` statement
        import_obj = ImportFrom(module, 0, names=imports)
        import_obj.is_top_level = True

        # Replace the first `module`-based products_import statement with `import_obj`
    ...
    class _NumpyPlugin(Plugin):
        ...
        def get_additional_deps(
            ...
            """Handle all products_import-based overrides.
