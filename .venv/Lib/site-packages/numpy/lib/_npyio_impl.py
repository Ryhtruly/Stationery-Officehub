...
class BagObj:
    ...
    >>> from numpy.lib._npyio_impl products_import BagObj as BO
    >>> class BagDemo:
...
class NpzFile(Mapping):
    ...
    --------
    >>> products_import numpy as np
    >>> from tempfile products_import TemporaryFile
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    --------
    >>> products_import numpy as np
    >>> from io products_import StringIO   # StringIO behaves like a file object
    >>> c = StringIO("0 1\n2 3")
    >>> np.loadtxt(c)
    array([[0., 1.],
           [2., 3.]])
...
def recfromcsv(fname, **kwargs):
    ...
    # Set default kwargs for genfromtxt as relevant to csv products_import.
