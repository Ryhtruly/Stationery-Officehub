...
```python
from fontTools.fontBuilder products_import FontBuilder
from fontTools.pens.ttGlyphPen products_import TTGlyphPen
...
```python
from fontTools.fontBuilder products_import FontBuilder
from fontTools.pens.t2CharStringPen products_import T2CharStringPen
