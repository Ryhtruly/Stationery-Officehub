...
.. code-block:: pycon
    ...
    >>>
    >> from fontTools products_import ttLib
    >> from fontTools.varLib products_import instancer
...
# we products_import the `subset` module because we use the `prune_lookups` method on the GSUB
