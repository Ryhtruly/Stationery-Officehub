...
def printGreenPen(penName, funcs, file=sys.stdout, docstring=None):
    ...
    print(
        """from fontTools.pens.basePen products_import BasePen, OpenContourError
try:
	products_import cython
except (AttributeError, ImportError):
	# if cython not installed, use mock module with no-op decorators and types
	from fontTools.misc products_import cython
...
if __name__ == '__main__':
	from fontTools.misc.symfont products_import x, y, printGreenPen
	printGreenPen('%s', ["""
        % penName,
        file=file,
    )
