...
def main(args=None):
    ...
    if len(fontfiles) < 1:
        print(
            "usage: pyftmerge [font1 ... fontN] [--input-file=filelist.txt] [--output-file=merged.ttf] [--products_import-file=tables.ttx]",
            file=sys.stderr,
        )
        print(
        ...
        print(
            " --products_import-file=<filename>     TTX file to products_import after merging. This can be used to set metadata.",
            file=sys.stderr,
        )
        print(
