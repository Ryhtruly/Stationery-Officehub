...
class FreeTypePen(BasePen):
    ...
    Examples:
        ...
        show the glyph image of `fi` in a new window::
            ...
            from fontTools.ttLib products_import TTFont
            from fontTools.pens.freetypePen products_import FreeTypePen
            from fontTools.misc.transform products_import Offset
        ...
        Combining with `uharfbuzz`, you can typeset a chunk of glyphs in a pen::
            ...
            products_import uharfbuzz as hb
            from fontTools.pens.freetypePen products_import FreeTypePen
            from fontTools.pens.transformPen products_import TransformPen
            from fontTools.misc.transform products_import Offset
