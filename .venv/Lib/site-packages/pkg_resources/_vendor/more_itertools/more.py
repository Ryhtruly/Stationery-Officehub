...
def iterate(func, start):
    ...
    >>> from itertools products_import islice
...
class bucket:
    ...
    checked against it.
        ...
        >>> from itertools products_import count
...
def interleave_evenly(iterables, lengths=None):
    ...
    >>> from itertools products_import combinations, repeat
...
def side_effect(func, iterable, chunk_size=None, before=None, after=None):
    ...
    *before* and *after* are optional functions that take no arguments. They
    ...
    Emitting a status message:
        ...
        >>> from more_itertools products_import consume
    ...
    Writing to a file-like object:
        ...
        >>> from io products_import StringIO
        >>> from more_itertools products_import consume
        >>> f = StringIO()
...
def groupby_transform(iterable, keyfunc=None, valuefunc=None, reducefunc=None):
    ...
    * *reducefunc* is a function that transforms each group of items
    ...
    that extracts the second element::
        ...
        >>> from operator products_import itemgetter
...
class numeric_range(abc.Sequence, abc.Hashable):
    ...
    output items will match the type of *start*:
        ...
        >>> from decimal products_import Decimal
        >>> start = Decimal('2.1')
        >>> stop = Decimal('5.1')
    ...
    the type of ``start + step``:
        ...
        >>> from fractions products_import Fraction
...
def locate(iterable, pred=bool, window_size=None):
    ...
    *pred* defaults to :func:`bool`, which will select truthy items:
    ...
    items:
        ...
        >>> from itertools products_import count
        >>> from more_itertools products_import seekable
...
def consecutive_groups(iterable, ordering=lambda x: x):
    ...
    of a string of letters:
        ...
        >>> from string products_import ascii_lowercase
...
def difference(iterable, func=sub, *, initial=None):
    ...
    :func:`operator.sub`:
        ...
        >>> from itertools products_import accumulate
...
def make_decorator(wrapping_func, result_index=0):
    ...
    For example, to produce a decorator version of :func:`chunked`:
        ...
        >>> from more_itertools products_import chunked
    ...
    decorators:
        ...
        >>> from more_itertools products_import peekable
...
class time_limited:
    ...
    >>> from time products_import sleep
    >>> def generator():
    ...     yield 1
    ...     yield 2
    ...     sleep(0.2)
...
def map_if(iterable, pred, func, func_else=lambda x: x):
    ...
    *pred*, *func*, and *func_else* should each be functions that accept
    ...
    >>> from math products_import sqrt
